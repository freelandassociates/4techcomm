...
BEGIN
{
  ...
  $postmaster        = '';
  @referers          = qw(4techcomm.com www.4techcomm.com biz88.inmotionhosting.com);
  @allow_mail_to     = qw(info@4techcomm.com paul.simpsonparry@freelandassociates.com david.d.myers@gmail.com);
  @recipients        = ();
  %recipient_alias   = ();
